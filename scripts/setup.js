...
`);
  ...
  console.log('\nDeploying to Vercel? Add DATA_BACKEND and FIREBASE_SERVICE_ACCOUNT_BASE64');
  console.log('as Environment Variables in the Vercel dashboard (Production scope).');
}
